...
write.csv(und.org.abv,file=paste(path2G,"und.org.abv.csv", sep = ""), header=TRUE)
write.csv(und.org.bel,file=paste(path2G,"und.org.bel.csv", sep = ""), header=TRUE)

# copy ppa data to windows G
write.csv(basal.tree, file=paste(path2G,"ppadata.txt",sep=""), header=TRUE)

# copy all other SF data to windows G
write.csv(nwl.sf.nfi9013.org.abv,file=paste(path2G,"nwl.sf.1990",yr,".org.abv.csv", sep = ""), header=TRUE)
write.csv(fwl.sf.nfi9013.org.abv,file=paste(path2G,"fwl.sf.1990",yr,".org.abv.csv", sep = ""), header=TRUE)
write.csv(nwl.sf.nfi9013.org.bel,file=paste(path2G,"nwl.sf.1990",yr,".org.bel.csv", sep = ""), header=TRUE)
write.csv(fwl.sf.nfi9013.org.bel,file=paste(path2G,"fwl.sf.1990",yr,".org.bel.csv", sep = ""), header=TRUE)

write.csv(nat.nwl.SF.org.abv,file=paste(path2G,"nat.nwl.SF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.nwl.SF.org.bel,file=paste(path2G,"nat.nwl.SF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.fwl.SF.org.abv,file=paste(path2G,"nat.fwl.SF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.fwl.SF.org.bel,file=paste(path2G,"nat.fwl.SF.org.bel.csv", sep=""), header=TRUE)
write.csv(nat.cwl.SF.org.abv,file=paste(path2G,"nat.cwl.SF.org.abv.csv", sep=""), header=TRUE)

write.csv(log.nwl.SF.org.abv,file=paste(path2G, "log.nwl.SF.org.abv.csv", sep=""), header=TRUE)
write.csv(log.nwl.SF.org.bel,file=paste(path2G, "log.nwl.SF.org.bel.csv", sep=""), header=TRUE)
write.csv(log.fwl.SF.org.abv,file=paste(path2G, "log.fwl.SF.org.abv.csv", sep=""), header=TRUE)
write.csv(log.fwl.SF.org.bel,file=paste(path2G, "log.fwl.SF.org.bel.csv", sep=""), header=TRUE)
write.csv(log.cwl.SF.org.abv,file=paste(path2G, "log.cwl.SF.org.abv.csv", sep=""), header=TRUE)
...
write.csv(nwl.nf.nfi9013.org.abv,file=paste(path2G,"nwl.nf.1990",yr,".org.abv.csv", sep = ""), header=TRUE)
write.csv(fwl.nf.nfi9013.org.abv,file=paste(path2G,"fwl.nf.1990",yr,".org.abv.csv", sep = ""), header=TRUE)
write.csv(nwl.nf.nfi9013.org.bel,file=paste(path2G,"nwl.nf.1990",yr,".org.bel.csv", sep = ""), header=TRUE)
write.csv(fwl.nf.nfi9013.org.bel,file=paste(path2G,"fwl.nf.1990",yr,".org.bel.csv", sep = ""), header=TRUE)

write.csv(nat.nwl.NF.org.abv,file=paste(path2G,"nat.nwl.NF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.nwl.NF.org.bel,file=paste(path2G,"nat.nwl.NF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.fwl.NF.org.abv,file=paste(path2G,"nat.fwl.NF.org.abv.csv", sep=""), header=TRUE)
write.csv(nat.fwl.NF.org.bel,file=paste(path2G,"nat.fwl.NF.org.bel.csv", sep=""), header=TRUE)
write.csv(nat.cwl.NF.org.abv,file=paste(path2G,"nat.cwl.NF.org.abv.csv", sep=""), header=TRUE)

write.csv(log.nwl.NF.org.abv,file=paste(path2G, "log.nwl.NF.org.abv.csv", sep=""), header=TRUE)
write.csv(log.nwl.NF.org.bel,file=paste(path2G, "log.nwl.NF.org.bel.csv", sep=""), header=TRUE)
write.csv(log.fwl.NF.org.abv,file=paste(path2G, "log.fwl.NF.org.abv.csv", sep=""), header=TRUE)
write.csv(log.fwl.NF.org.bel,file=paste(path2G, "log.fwl.NF.org.bel.csv", sep=""), header=TRUE)
write.csv(log.cwl.NF.org.abv,file=paste(path2G, "log.cwl.NF.org.abv.csv", sep=""), header=TRUE)
