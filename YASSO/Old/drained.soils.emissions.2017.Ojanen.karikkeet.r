...
#modified for new emission factors by Ojanen et al. 2013 and above-ground litter, 16.9.2019 AW
...
Mtkg1.emis.sf <- (litter.bel.sf+litter.abv.sf -Mtkg1)+dom.sf
Mtkg2.emis.sf <- (litter.bel.sf+litter.abv.sf-Mtkg2)+dom.sf
Ptkg1.emis.sf <- (litter.bel.sf+litter.abv.sf-Ptkg1)+dom.sf
Ptkg2.emis.sf <- (litter.bel.sf+litter.abv.sf-Ptkg2)+dom.sf
...
write.csv(tkg.emiss.sf, (paste(resultspath,"tkg.emiss.sf.Ojanen.karikkeet.csv", sep="")))
...
Mtkg1.emis.nf <- (litter.bel.nf+litter.abv.nf-Mtkg1)+dom.nf
Mtkg2.emis.nf <- (litter.bel.nf+litter.abv.nf-Mtkg2)+dom.nf
Ptkg1.emis.nf <- (litter.bel.nf+litter.abv.nf-Ptkg1)+dom.nf
Ptkg2.emis.nf <- (litter.bel.nf+litter.abv.nf-Ptkg2)+dom.nf
...
write.csv(tkg.emiss.nf, (paste(resultspath,"tkg.emiss.nf.Ojanen.karikkeet.csv", sep="")))
# NIR appendix
