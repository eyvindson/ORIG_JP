...
#######CONSTANT WEATHER AND LITTER FROM LOGGINNGS AND NATURAL MORTALITY USED 31.8.2022 AW
yr <- 2019
yr.VANHA <- 2018
...
climate =  read.table(paste(climpath,"GHG_climate_1960_2019_vakioitu.csv",sep=""), header = TRUE, sep=",") 
...
#here copying data from 1990 to the end of times
nwl[1:48, ] <- nwl[19, ]
