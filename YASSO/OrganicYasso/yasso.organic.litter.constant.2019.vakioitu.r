...
########this version uses the same weather as in 1990 to the end of time to remove the effect of weather
yr <- 2019
yr.VANHA <- 2018
...
write.csv(litter.sf, (paste(resultspath,"NEW.litter.sf.",yr,".csv", sep="")))

litter.sf.awenh <- cbind(nwl, fwl, cwl)
#write.csv(litter.sf.awenh, (paste(resultspath,"litter.sf.awenh.csv", sep="")))
write.csv(litter.sf.awenh, (paste(resultspath,"NEW.litter.sf.awenh.csv", sep="")))
...
write.csv(soil.sf.awenh, (paste(resultspath,"vakioitu.soil.sf.awenh.csv", sep="")))
...
write.csv(d.soil.c.sf.s.out, (paste(resultspath,"NEW.d.soil.c.tot.sf.s.mean.csv", sep="")))
...
write.csv(litter.nf, (paste(resultspath,"NEW.litter.nf.",yr,".csv", sep="")))

litter.nf.awenh <- cbind(nwl, fwl, cwl)
#write.csv(litter.nf.awenh, (paste(resultspath,"litter.nf.awenh.csv", sep="")))
write.csv(litter.nf.awenh, (paste(resultspath,"NEW.litter.nf.awenh.csv", sep="")))
...
write.csv(soil.nf.awenh, (paste(resultspath,"vakioitu.soil.nf.awenh.csv", sep="")))
###############
...
write.csv(d.soil.c.nf.s.out, (paste(resultspath,"NEW.d.soil.c.tot.nf.s.mean.csv", sep="")))
