...
#23.9.2021 /AW
################## NOTE HERE USING CONSTANT LITTER from logging residues
...
####modified to make litter constant using data from 1990 31.8.2020 AW
yr <- 2019
yr.VANHA <- 2018
...
#k?ytt?? VMI koealojen perusteella laskettua s??dataa
...
write.csv(litter.sf, (paste(resultspath,"constant.litter.sf.",yr,".csv", sep="")))

litter.sf.awenh <- cbind(nwl, fwl, cwl)
#write.csv(litter.sf.awenh, (paste(resultspath,"litter.sf.awenh.csv", sep="")))
write.csv(litter.sf.awenh, (paste(resultspath,"constant.litter.sf.awenh.csv", sep="")))
...
write.csv(soil.sf.awenh, (paste(resultspath,"constant.soil.sf.awenh.csv", sep="")))
...
write.csv(d.soil.c.sf.s.out, (paste(resultspath,"constant.d.soil.c.tot.sf.s.mean.csv", sep="")))
...
write.csv(litter.nf, (paste(resultspath,"constant.litter.nf.",yr,".csv", sep="")))
...
write.csv(soil.nf.awenh, (paste(resultspath,"constant.soil.nf.awenh.csv", sep="")))
###############
...
write.csv(d.soil.c.nf.s.out, (paste(resultspath,"constant.d.soil.c.tot.nf.s.mean.csv", sep="")))
