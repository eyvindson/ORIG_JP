...
####modified to make climate constant using data from 1990 31.8.2020 AW
yr <- 2019
yr.VANHA <- 2018
...
#using climate data based on locations of VMI sample plots
...
write.csv(soil.sf.awenh, (paste(resultspath,"clima.soil.sf.awenh.csv", sep="")))
...
write.csv(d.soil.c.sf.s.out, (paste(resultspath,"clima.d.soil.c.tot.sf.s.mean.csv", sep="")))
...
write.csv(soil.nf.awenh, (paste(resultspath,"clima.soil.nf.awenh.csv", sep="")))
###############
...
write.csv(d.soil.c.nf.s.out, (paste(resultspath,"clima.d.soil.c.tot.nf.s.mean.csv", sep="")))
