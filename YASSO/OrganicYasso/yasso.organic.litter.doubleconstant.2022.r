...
#######CONSTANT WEATHER AND LITTER FROM LOGGINNGS AND NATURAL MORTALITY from the year 1990  31.8.2022 AW
yr <- 2019
yr.VANHA <- 2018
...
# climate data calculated based on location of VMI sample plots
...
#here repeating climate data from the year 1990 starting from year 1972 for South and from 1975 for North Finland
cl.sf=matrix(rep(clim7012.sf[19,],30),nrow=30,byrow=TRUE)
cl.nf=matrix(rep(clim7012.nf[16,],30),nrow=30,byrow=TRUE)

clim7012.sf=rbind(c.sf,cl.sf)
clim7012.nf=rbind(c.nf,cl.nf)


write.csv(clim7012.sf, (paste(resultspath,"clima.sf.",yr,".csv", sep="")))
write.csv(clim7012.nf, (paste(resultspath,"clima.nf.",yr,".csv", sep="")))
...
write.csv(spin.sf.sum, (paste(resultspath,"new.spin.sf.sum.csv", sep="")))
...
write.csv(spin.nf.sum, (paste(resultspath,"new.spin.nf.sum.csv", sep="")))
...
write.table(FL.spin.litter, paste(resultspath,"NEW.FL.soil.init.CInput.csv", sep=""), sep=" ", row.names = TRUE, col.names = TRUE, quote=FALSE)
...
#here removing roots, foliage and branched from naural mortality
...
###here making litter constant starting from 1990
#here taking data from year 1972 to 1989
nwlstart <- nwl[1:18, ]

nwlstart
#here taking data from year 1990 to 2019
nwl
nwlend <- nwl[19, ]
nwlend
nwlend[1:30,] <- nwl[19,]
nwlend
#here putting together to form data from 1972 to 2019
nwl <- rbind(nwlstart,nwlend)
nwl
...
write.csv(litter.sf, (paste(resultspath,"Dconstant.litter.sf.",yr,".csv", sep="")))

litter.sf.awenh <- cbind(nwl, fwl, cwl)
#write.csv(litter.sf.awenh, (paste(resultspath,"litter.sf.awenh.csv", sep="")))
write.csv(litter.sf.awenh, (paste(resultspath,"Dconstant.litter.sf.awenh.csv", sep="")))
...
write.csv(soil.sf.awenh, (paste(resultspath,"Dconstant.soil.sf.awenh.csv", sep="")))
...
write.csv(d.soil.c.sf.s.out, (paste(resultspath,"Dconstant.d.soil.c.tot.sf.s.mean.csv", sep="")))
...
###here making litter constant starting from 1990
#here taking data from year 1982 to 1989
nwlstart <- nwl[1:8, ]
...
nwlend[1:30,] <- nwl[9,]
nwlend
#here putting together to form data from 1982 to 2019
nwl <- rbind(nwlstart,nwlend)
nwl
...
write.csv(litter.nf, (paste(resultspath,"Dconstant.litter.nf.",yr,".csv", sep="")))

litter.nf.awenh <- cbind(nwl, fwl, cwl)
#write.csv(litter.nf.awenh, (paste(resultspath,"litter.nf.awenh.csv", sep="")))
write.csv(litter.nf.awenh, (paste(resultspath,"constant.litter.nf.awenh.csv", sep="")))
...
write.csv(soil.nf.awenh, (paste(resultspath,"Dconstant.soil.nf.awenh.csv", sep="")))
###############
...
write.csv(d.soil.c.nf.s.out, (paste(resultspath,"Dconstant.d.soil.c.tot.nf.s.mean.csv", sep="")))
